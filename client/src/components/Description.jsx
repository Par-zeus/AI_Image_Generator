...
const Description = () => {
  return (
    ...
    className='flex flex-col items-center justify-center my-24 p-6 md:px-28'>
        ...
        <div className='flex flex-col gap-5 md:flex-row items-center md:gap-14'>
            ...
            <div>
                ...
                <p className='text-gray-600 mb-4'>Easily bring your ideas to life with our free AI image generator.
                    ...
                    your text into eye-catching images with just few clicks. Imagine it, describe it,and watch it come to life instantly. 
                </p>
                <p className='text-gray-600'>Simply type in a text-prompt , and our cutting-edge AI will generate high-quality images in seconds. From product visuals to character designs and portraits, even concept that don't yet exist can be visualized effortlessly. Powered by advanced AI technology, the creative possiblities are limitless.  </p>
            </div>
        </div>
    </motion.div>
  )
